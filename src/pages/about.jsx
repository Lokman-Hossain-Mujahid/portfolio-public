            ...
            <main className='flex w-full flex-col items-center justify-center dark:text-light'>
                <Layout className='pt-16'>
                    ...
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        ...
                        <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 dark:bg-dark dark:border-light x;l:col-span-4 md:order-1 md:col-span-8'>
                        ...
                        <div className='col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3'>
                            ...
                            <div className='flex flex-col items-end justify-center xl:items-center'>
                                ...
                                <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm'>Skills Learned</h2>
                            </div>
                        </div>
                    </div>
                    <Skills />
