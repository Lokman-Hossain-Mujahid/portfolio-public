...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
    ...
    return (
        <article className='w-full flex items-center justify-between relative rounded-br-2xl rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12 dark:bg-dark dark:border-light'>
            ...
            <div className='absolute top-0 -right-3 -z-10 w-[100.80%] h-[103%] rounded-[2.5rem] bg-dark dark:bg-light rounded-br-3xl' />
...
const Project = ({ title, type, img, link, github }) => {
    ...
    return (
        <article className='w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light'>
            ...
            <div className='absolute top-0 -right-3 -z-10 w-[101.50%] h-[103%] rounded-[2rem] bg-dark rounded-br-3xl dark:bg-light' />
